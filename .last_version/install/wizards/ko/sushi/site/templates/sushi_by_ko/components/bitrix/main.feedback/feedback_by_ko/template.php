...
<?=bitrix_sessid_post()?>
	...
	<div class="mf-email">
		...
		<input type="text" required name="user_email" value="<?=$arResult["AUTHOR_EMAIL"]?>" placeholder="<?=GetMessage("MFT_EMAIL")?>">
	</div>
	...
	<div class="mf-message">
		...
		<textarea required name="MESSAGE" rows="5" cols="40" placeholder="<?=GetMessage("MESSAGE")?>"><?=$arResult["MESSAGE"]?></textarea>
	</div>
