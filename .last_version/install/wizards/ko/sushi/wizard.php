...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/ko/sushi/site/templates/sushi_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.png"))
			$siteLogo = "/bitrix/wizards/ko/sushi/site/templates/sushi_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png";
